...
#endif
#ifdef CONFIG_RT_GROUP_SCHED
extern int sched_group_set_rt_runtime(struct task_group *tg, bool task_data,
				      long rt_runtime_us);
extern long sched_group_rt_runtime(struct task_group *tg, bool task_data);
extern int sched_group_set_rt_period(struct task_group *tg, bool task_data,
				      long rt_period_us);
extern long sched_group_rt_period(struct task_group *tg, bool task_data);
