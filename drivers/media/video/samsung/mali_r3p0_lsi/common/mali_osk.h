 ...
 */
#define _mali_ukk_release_ump_mem new_mali_ukk_release_ump_mem
#define _mali_ukk_mem_munmap new_mali_ukk_mem_munmap
#define mali_utilization_core_end new_mali_utilization_core_end
#define mali_mmu_release_table_page new_mali_mmu_release_table_page
#define _mali_ukk_get_gp_core_version new_mali_ukk_get_gp_core_version
#define mali_descriptor_mapping_get new_mali_descriptor_mapping_get
#define mali_allocation_engine_allocate_page_tables new_mali_allocation_engine_allocate_page_tables
#define _mali_ukk_report_memory_usage new__mali_ukk_report_memory_usage
#define _mali_ukk_open new__mali_ukk_open
#define mali_allocation_engine_memory_usage new_mali_allocation_engine_memory_usage
#define mali_driver_exit new_mali_driver_exit
#define _mali_ukk_init_mem new__mali_ukk_init_mem
#define _mali_dev_platform_unregister new__mali_dev_platform_unregister
#define _mali_osk_specific_indirect_mmap new__mali_osk_specific_indirect_mmap
#define _mali_ukk_pp_start_job new__mali_ukk_pp_start_job
#define _mali_ukk_mem_mmap new__mali_ukk_mem_mmap
#define _mali_ukk_query_mmu_page_table_dump_size new__mali_ukk_query_mmu_page_table_dump_size
#define _mali_osk_specific_indirect_munmap new__mali_osk_specific_indirect_munmap
#define _mali_ukk_get_system_info_size new__mali_ukk_get_system_info_size
#define _mali_ukk_map_external_mem new__mali_ukk_map_external_mem
#define _mali_ukk_unmap_external_mem new__mali_ukk_unmap_external_mem
#define mali_descriptor_mapping_destroy new_mali_descriptor_mapping_destroy
#define mali_descriptor_mapping_call_for_each new_mali_descriptor_mapping_call_for_each
#define mali_utilization_core_start new_mali_utilization_core_start
#define _mali_ukk_dump_mmu_page_table new__mali_ukk_dump_mmu_page_table
#define mali_utilization_term new_mali_utilization_term
#define _mali_ukk_get_pp_core_version new__mali_ukk_get_pp_core_version
#define _mali_ukk_vsync_event_report new__mali_ukk_vsync_event_report
#define _mali_ukk_wait_for_notification new__mali_ukk_wait_for_notification
#define _mali_ukk_get_gp_number_of_cores new__mali_ukk_get_gp_number_of_cores
#define mali_allocation_engine_unmap_physical new_mali_allocation_engine_unmap_physical
#define mali_os_allocator_create new_mali_os_allocator_create
#define _mali_ukk_gp_start_job new__mali_ukk_gp_start_job
#define _mali_ukk_get_pp_number_of_cores new__mali_ukk_get_pp_number_of_cores
#define map_errcode new_map_errcode
#define mali_allocation_engine_map_physical new_mali_allocation_engine_map_physical
#define mali_descriptor_mapping_allocate_mapping new_mali_descriptor_mapping_allocate_mapping
#define _mali_dev_platform_register new__mali_dev_platform_register
#define _mali_ukk_get_api_version new__mali_ukk_get_api_version
#define mali_allocation_engine_allocate_memory new_mali_allocation_engine_allocate_memory
#define mali_descriptor_mapping_set new_mali_descriptor_mapping_set
#define mali_mmu_get_table_page new_mali_mmu_get_table_page
#define _mali_ukk_term_mem new__mali_ukk_term_mem
#define mali_allocation_engine_destroy new_mali_allocation_engine_destroy
#define mali_utilization_init new_mali_utilization_init
#define _mali_ukk_post_notification new__mali_ukk_post_notification
#define _mali_ukk_get_system_info new__mali_ukk_get_system_info
#define mali_allocation_engine_report_allocators new_mali_allocation_engine_report_allocators
#define mali_dev_pause new_mali_dev_pause
#define mali_block_allocator_create new_mali_block_allocator_create
#define mali_sysfs_unregister new_mali_sysfs_unregister
#define mali_allocation_engine_create new_mali_allocation_engine_create
#define mali_allocation_engine_release_memory new_mali_allocation_engine_release_memory
#define _mali_ukk_gp_suspend_response new__mali_ukk_gp_suspend_response
#define vsync_event_report_wrapper new_vsync_event_report_wrapper
#define _mali_ukk_attach_ump_mem new__mali_ukk_attach_ump_mem
#define mali_utilization_suspend new_mali_utilization_suspend
#define mali_hang_check_interval new_mali_hang_check_interval
#define mali_dev_resume new_mali_dev_resume
#define mali_sysfs_register new_mali_sysfs_register
#define _mali_ukk_close new__mali_ukk_close
#define mali_driver_init new_mali_driver_init
#define mali_descriptor_mapping_create new_mali_descriptor_mapping_create
#define mali_descriptor_mapping_free new_mali_descriptor_mapping_free
#define mali_max_job_runtime new_mali_max_job_runtime
#define mali_gpu_device new_mali_gpu_device
#define mali_major new_mali_major
#define mali_debug_level new_mali_debug_level
#define mali_gpu_utilization_timeout new_mali_gpu_utilization_timeout
#define mali_l2_max_reads new_mali_l2_max_reads
#define mali_max_job_runtime new_mali_max_job_runtime
#define mali_fops new_mali_fops
#define _mali_osk_notification_queue_receive new__mali_osk_notification_queue_receive
#define _mali_osk_mem_mapregion_term new__mali_osk_mem_mapregion_term
#define _mali_osk_resources_term new__mali_osk_resources_term
#define _mali_osk_flush_workqueue new__mali_osk_flush_workqueue
#define _mali_osk_timer_term new__mali_osk_timer_term
#define _mali_osk_resources_init new__mali_osk_resources_init
#define _mali_osk_write_mem_barrier new__mali_osk_write_mem_barrier
#define _mali_osk_mem_barrier new__mali_osk_mem_barrier
#define mem_query_mmu_page_table_dump_size_wrapper new_mem_query_mmu_page_table_dump_size_wrapper
#define _mali_osk_timer_init new__mali_osk_timer_init
#define _mali_osk_timer_setcallback new__mali_osk_timer_setcallback
#define _mali_osk_timer_mod new__mali_osk_timer_mod
#define _mali_osk_mem_ioread32 new__mali_osk_mem_ioread32
#define _mali_osk_irq_schedulework new__mali_osk_irq_schedulework
#define mali_osk_low_level_mem_term new_mali_osk_low_level_mem_term
#define _mali_osk_time_tickstoms new__mali_osk_time_tickstoms
#define get_system_info_wrapper new_get_system_info_wrapper
#define mali_osk_low_level_mem_init new_mali_osk_low_level_mem_init
#define _mali_osk_notification_queue_init new__mali_osk_notification_queue_init
#define _mali_osk_notification_queue_term new__mali_osk_notification_queue_term
#define mem_release_ump_wrapper new_mem_release_ump_wrapper
#define _mali_osk_mem_unreqregion new__mali_osk_mem_unreqregion
#define mem_unmap_ext_wrapper new_mem_unmap_ext_wrapper
#define _mali_osk_notification_queue_dequeue new__mali_osk_notification_queue_dequeue
#define _mali_osk_timer_add new__mali_osk_timer_add
#define _mali_osk_notification_create new__mali_osk_notification_create
#define _mali_osk_mem_reqregion new__mali_osk_mem_reqregion
#define _mali_osk_time_after new__mali_osk_time_after
#define _mali_osk_time_ubusydelay new__mali_osk_time_ubusydelay
#define mem_dump_mmu_page_table_wrapper new_mem_dump_mmu_page_table_wrapper
#define get_api_version_wrapper new_get_api_version_wrapper
#define _mali_osk_irq_init new__mali_osk_irq_init
#define _mali_osk_timer_del new__mali_osk_timer_del
#define _mali_osk_mem_freeioregion new__mali_osk_mem_freeioregion
#define mem_attach_ump_wrapper new_mem_attach_ump_wrapper
#define _mali_osk_time_tickcount new__mali_osk_time_tickcount
#define _mali_osk_mem_mapregion_init new__mali_osk_mem_mapregion_init
#define _mali_osk_time_tickcount new__mali_osk_time_tickcount
#define wait_for_notification_wrapper new_wait_for_notification_wrapper
#define _mali_osk_mem_unmapioregion new__mali_osk_mem_unmapioregion
#define mem_term_wrapper new_mem_term_wrapper
#define _mali_osk_mem_iowrite32_relaxed new__mali_osk_mem_iowrite32_relaxed
#define _mali_osk_irq_term new__mali_osk_irq_term
#define _mali_osk_mem_allocioregion new__mali_osk_mem_allocioregion
#define _mali_osk_cache_flushall new__mali_osk_cache_flushall
#define pp_get_core_version_wrapper new_pp_get_core_version_wrapper
#define get_system_info_size_wrapper new_get_system_info_size_wrapper
#define gp_get_core_version_wrapper new_gp_get_core_version_wrapper
#define _mali_osk_mem_mapregion_map new__mali_osk_mem_mapregion_map
#define _mali_osk_time_mstoticks new__mali_osk_time_mstoticks
#define gp_get_number_of_cores_wrapper new__gp_get_number_of_cores_wrapper
#define _mali_osk_mem_mapregion_unmap new__mali_osk_mem_mapregion_unmap
#define gp_suspend_response_wrapper new_gp_suspend_response_wrapper
#define gp_start_job_wrapper new_gp_start_job_wrapper
#define _mali_osk_notification_queue_send new__mali_osk_notification_queue_send
#define pp_get_number_of_cores_wrapper new_pp_get_number_of_cores_wrapper
#define _mali_osk_cache_ensure_uncached_range_flushed new__mali_osk_cache_ensure_uncached_range_flushed
#define pp_start_job_wrapper new_pp_start_job_wrapper
#define _mali_osk_mem_mapioregion new__mali_osk_mem_mapioregion
#define mem_map_ext_wrapper new_mem_map_ext_wrapper
#define _mali_osk_notification_delete new__mali_osk_notification_delete
#define mem_init_wrapper new_mem_init_wrapper
#define _mali_osk_time_get_ns new__mali_osk_time_get_ns
#define _mali_osk_mem_iowrite32 new__mali_osk_mem_iowrite32
#define post_notification_wrapper new_post_notification_wrapper
#define mali_utilization_core_end new_mali_utilization_core_end
#define mali_regulator_get_usecount new_mali_regulator_get_usecount
#define mali_clk_get new_mali_clk_get
#define mali_clk_get_rate new_mali_clk_get_rate
#define mali_gpu_vol new_mali_gpu_vol
#define gpu_power_state new_gpu_power_state
#define mali_gpu_utilization_handler new_mali_gpu_utilization_handler
#define mali_platform_init new_mali_platform_init
#define mali_regulator_set_voltage new_mali_regulator_set_voltage
#define mali_platform_powerdown new_mali_platform_powerdown
#define mali_voltage_lock_init new_mali_voltage_lock_init
#define g3d_power_domain_control new_g3d_power_domain_control
#define mali_platform_power_mode_change new_mali_platform_power_mode_change
#define mali_runtime_resume new_mali_runtime_resume
#define new__mali_ukk_open new_new__mali_ukk_open
#define mali_dvfs_lock new_mali_dvfs_lock
#define mali_voltage_lock_push new_mali_voltage_lock_push
#define mali_regulator_enable new_mali_regulator_enable
#define set_mali_parent_power_domain new_set_mali_parent_power_domain
#define clk_register_map new_clk_register_map
#define mali_clk_put new_mali_clk_put
#define mali_platform_deinit new_mali_platform_deinit
#define mali_regulator_disable new_mali_regulator_disable
#define mali_voltage_lock_pop new_mali_voltage_lock_pop
#define mali_lock_vol new_mali_lock_vol
#define mali_clk_set_rate new_mali_clk_set_rate
#define mali_gpu_clk new_mali_gpu_clk
#define new__mali_ukk_open new_new__mali_ukk_open
#define g3d_regulator new_g3d_regulator
#define mali_platform_powerup new_mali_platform_powerup
#define _mali_osk_break new__mali_osk_break
#define _mali_osk_abort new__mali_osk_abort
#define init_mali_dvfs_status new_init_mali_dvfs_status
#define step1_down new_step1_down
#define step2_down new_step2_down
#define mali_dvfs_bottom_lock_push new_mali_dvfs_bottom_lock_push
#define get_mali_dvfs_control_status new_get_mali_dvfs_control_status
#define mali_dvfs_all new_mali_dvfs_all
#define cpufreq_unlock_by_mali new_cpufreq_unlock_by_mali
#define step2_up new_step2_up
#define step4_down new_step4_down
#define mali_vol_get_from_table new_mali_vol_get_from_table
#define mali_runtime_resumed new_mali_runtime_resumed
#define cpufreq_lock_by_mali new_cpufreq_lock_by_mali
#define step1_clk new_step1_clk
#define mali_dvfs_staycount new_mali_dvfs_staycount
#define set_mali_dvfs_current_step new_set_mali_dvfs_current_step
#define mali_default_step_set new_mali_default_step_set
#define step2_vol new_step2_vol
#define step1_up new_step1_up
#define step3_vol new_step3_vol
#define step1_vol new_step1_vol
#define step3_down new_step3_down	
#define deinit_mali_dvfs_status new_deinit_mali_dvfs_status
#define step0_vol new_step0_vol
#define step0_clk new_step0_clk
#define mali_dvfs new_mali_dvfs
#define mali_dvfs_threshold new_mali_dvfs_threshold
#define mali_dvfs_control new_mali_dvfs_control
#define mali_dvfs_is_running new_mali_dvfs_is_running
#define step2_clk new_step2_clk
#define step4_clk new_step4_clk	
#define step3_up new_step3_up
#define step new_step
#define mali_cpufreq_lock new_mali_cpufreq_lock
#define mali_dvfs_bottom_lock_pop new_mali_dvfs_bottom_lock_pop
#define mali_dvfs_utilization new_mali_dvfs_utilization
#define step4_vol new_step4_vol
#define step3_clk new_step3_clk
#define mali_dvfs_handler new_mali_dvfs_handler
#define mali_dvfs_late_resume new_mali_dvfs_late_resume
#define step0_up new_step0_up
